...
Program Description: This program will allow for the programmer to perform simple tasks with pointers.
*/
...
// 17. Using cout and p2 only, display the address of the first element in a.
    cout << "#17: " << "The address of the first element is " << &(a[0]) << endl;
...
//     pointing to the first element of a.   Don't use pointer arithmetic.
    cout << "#18: " << "The address of the second element is " << &(a[1]) << endl;
...
/*
 ...
 #17: The address of the first element is 0x7ffee4c6b970
 #18: The address of the second element is 0x7ffee4c6b974
